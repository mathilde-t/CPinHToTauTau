    ...
    if channel=='mutau':
        ...
        mutau_signal_reg = add_category(
            ...
            aux={'control_reg': "mutau_control_reg",
                 'DR_num': 'mutau_det_reg_num',
                 'DR_den': 'mutau_det_reg_den',
                }
        )
        ...
        mutau_det_reg_num = add_category(
            config,
            name="mutau_det_reg_num",
            id=700 + mutau.id,
            selection=["cat_mutau"  ,
                       "os_charge"  ,
                       "mt_inv_cut"     ,
            ...
            label=r"$\mu\tau$ DR(num)",
        )
        
        mutau_det_reg_den = add_category(
            config,
            name="mutau_det_reg_den",
            id=750 + mutau.id,
            selection=["cat_mutau"  ,
                       "os_charge"  ,
                       "mt_inv_cut"     ,
