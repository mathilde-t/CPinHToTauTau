...
categories_mutau='cat_mutau_sr,cat_mutau_sr__tau2a1'
...
##############################
    ...
    "run3_2022preEE_mutau_lim")
        ...
        workflow='local'
    ;;
    "run3_2022preEE_mutau_lim_dmcs")
        config="run3_2022_preEE_mutau_limited"	
        datasets="data_mu_C,wj_incl_madgraph,$signal"
        processes='data,wj,h_ggf_htt_cpo,h_ggf_htt_mm,h_ggf_htt_sm'
	    categories=$categories_mutau
	    variables=$variables_mutau
        workflow='local'
    ;;
