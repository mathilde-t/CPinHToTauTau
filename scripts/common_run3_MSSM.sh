...
variables_emu='N_b_jets,N_jets_pT_20_eta_2_5_Tight,mjj,N_jets_pT_30_eta_4_7_Tight,Leading_jet_pt,Subleading_jet_pt,delta_eta_jj,jet_1_pt,emu_lep0_pt,emu_lep0_eta,emu_lep0_phi,emu_lep0_ip_sig,emu_lep1_pt,emu_lep1_eta,emu_lep1_phi,emu_lep1_ip_sig,emu_mt,emu_mvis,emu_delta_r,emu_pt,puppi_met_pt,puppi_met_phi'
